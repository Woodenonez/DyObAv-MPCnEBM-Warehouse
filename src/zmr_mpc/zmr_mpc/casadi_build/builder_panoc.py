from typing import Callable, TypedDict, Union, cast, Optional
...
class PanocBuilder:
    ...
    def build(self, use_tcp:bool=False, test:bool=False, save_dir: Optional[str]=None):
        ...
        build_dir = save_dir if save_dir else self._cfg.build_directory
