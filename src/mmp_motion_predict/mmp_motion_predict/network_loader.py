...
class NetworkLoader:
    ...
    def traj_to_input(self, input_traj: List[Tuple[float, float]], ref_image: torch.Tensor, normalize=True):
        ...
        # input_traj = [(254.92641924485744, 186.68000643855407), (254.87283848971492, 183.54001287710813), (254.6849706826832, 180.54003587564486), (254.75797785368277, 177.30020611038194), (254.58634542106557, 174.3003318501772)]
